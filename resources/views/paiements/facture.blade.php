    ...
    <div class="box-container">
        ...
        <div class="transaction-box">
            ...
            <div class="item">
                ...
                <div class="value">{{$fullPaymentInfo->employer->firstname}}
                    {{$fullPaymentInfo->employer->lastname}} ({{$fullPaymentInfo->employer->email}})</div>
            </div>
            <div class="item">
            ...
            <div class="item">
                ...
                <div class="value">{{$fullPaymentInfo->mois}} / {{$fullPaymentInfo->annee}} </div>
            </div>
            ...
            <div class="transaction_details_box">
                ...
                <div class="right">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>{{date('d-m-y', strtotime($fullPaymentInfo->date_lancement))}}</td>
                                <td>{{$fullPaymentInfo->montant}} FCFA</td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="single_item"> <span>Total</span>
                                        <span class="value">Montant du paiement -Fcfa</span>
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <div class="single_item">
                                        ...
                                        <span class="value">{{$fullPaymentInfo->montant}}</span>
                                    </div>
                                    <div class="single_item">
