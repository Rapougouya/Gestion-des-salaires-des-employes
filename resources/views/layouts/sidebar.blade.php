    ...
    <div class="sidepanel-inner d-flex flex-column">
        ...
        <div class="app-branding">
            <a class="app-logo" href="index.html">
                <img src="https://ui-avatars.com/api/?name={{AppNameGetter::getAppName() ? 
                    AppNameGetter::getAppName() : 'E-GESTION ' }}" class="logo-icon me-2" alt="user profil">
                    {{AppNameGetter::getAppName() ? 
                      AppNameGetter::getAppName() : 'E-GESTION ' }}
            </a>
        </div>          
        <nav id="app-nav-main" class="app-nav app-nav-main flex-grow-1">
            <ul class="app-menu list-unstyled accordion" id="menu-accordion">
                ...
                <li class="nav-item has-submenu">                    
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="{{route('administrateurs')}}">Listes des administrateurss</a></li>
                ...
                <li class="nav-item has-submenu">                    
                    ...
                    <div id="submenu-1" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="{{route('departement.index')}}">Listes des departements</a></li>
                ...
                <li class="nav-item has-submenu">
                    ...
                    <div id="submenu-2" class="collapse submenu submenu-1" data-bs-parent="#menu-accordion">
                        <ul class="submenu-list list-unstyled">
                            <li class="submenu-item"><a class="submenu-link" href="{{route('employer.index')}}">Listes des employés</a></li>
